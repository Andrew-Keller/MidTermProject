            ...
            <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
                <div class="d-flex justify-content-center">
                    <div class="text-center">
                    	<h3 style="background: black;color: snow;">Do you want to delete this quote?</h3>
...
#a message confirms that the quote has been deleted and shows the link to the index page
