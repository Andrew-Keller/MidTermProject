                        ...
                        <div class="d-flex h-100">
                            <div class="project-text w-100 my-auto text-center text-lg-left">
                            		...
                            		<div class="form-group">
    									<label for="exampleFormControlInput1">Quote Entry</label>
    									<input type="text" class="form-control" name="quote" placeholder="Enter the quote here:">
 									</div>
                            		<div class="form-group">
    									<label for="exampleFormControlSelect1">Authors</label>
    									<select class="form-control" name="author">
    										<?php
    										for($i=1;$i<count($authorarray);$i++){
    										?>
    										<option><?= $authorarray[$i][0].' '.$authorarray[$i][1] ?></option>
    										<?php
    										}
    										?>
    									</select>
                    ...
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card py-4 h-100">
                            <div class="card-body text-center">
                                ...
                                <div class="small text-black-50">Cincinnati, Ohio</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card py-4 h-100">
                            <div class="card-body text-center">
                                ...
                                <h4 class="text-uppercase m-0">School Email</h4>
                                <hr class="my-4 mx-auto" />
                                <div class="small text-black-50"><a href="#!">kellera11@mymail.nku.edu</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card py-4 h-100">
                            <div class="card-body text-center">
                                ...
                                <hr class="my-4 mx-auto" />
                                <div class="small text-black-50">andrewkeller256@gmail.com</div>
                            </div>
                        </div>
                    </div>
                </div>
